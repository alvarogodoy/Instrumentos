...
public class InstrumentoController {
    ...
    @PostMapping("/all")
    public ResponseEntity<List<Instrumento>> saveAll (@RequestBody List<Instrumento> instrumentos) {
        ArrayList<Instrumento> savedInstrumentos = (ArrayList<Instrumento>) instrumentoRepository.saveAll(instrumentos);
        return ResponseEntity.ok(savedInstrumentos);
    }
